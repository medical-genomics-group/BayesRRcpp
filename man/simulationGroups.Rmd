...
BayesRSamplerV2("./simG.csv",2, 20000, 15000,5,XX, Y,sigma0,v0E,s02E,v0G,s02G,cva)
...
G= 2.0 #number of groups
GroupAssignment= c(rep(0,M1),rep(1,M2),sample(c(0,1),MT-(M1+M2),replace=T))
