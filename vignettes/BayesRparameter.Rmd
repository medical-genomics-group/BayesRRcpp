---
title: "Miscellaneous observations about BayesR"
output:
...
First we generate the testing data set
```{r}
...
This small example only contained data generated from a single mixture.
Conjectures:
Bayes R prior meaning relates more to the number of markers allowed in the model
SigmaBeta prior meaning relates to the mean scale of the effects.
